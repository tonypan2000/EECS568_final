...
from unet.datasets.preprocess import *
from unet.models.network import *
from unet.models.process_network import *
from unet.scripts.label_visualize import *


if __name__ == '__main__':
    ########################################################################
    image_folder = '2011_09_26_drive_0079_sync'
    ########################################################################
    ...
    (len_train_label, train_label_loader) = load_data_labelID(
        'unet/training/gtFine_trainvaltest/gtFine',  #/home/chendh/Pytorch_Projects/jupyter_notebook_files/EECS504_Files/Project/Datasets/gtFine_trainvaltest/gtFine; /home/chendh/Desktop/label
        'train', transform, batch_size_train, shuffle=False
    )
    (len_train_raw, train_raw_loader) = load_data_raw(
        'unet/training/leftImg8bit_trainvaltest/leftImg8bit',  #/home/chendh/Pytorch_Projects/jupyter_notebook_files/EECS504_Files/Project/Datasets/leftImg8bit_trainvaltest/leftImg8bit; /home/chendh/Desktop/raw
        'train', transform, batch_size_train, shuffle=False
    )
    ...
    if flag_mode == 1:
        ...
        start_epoch = 68
        weights_file_path = 'unet/model/weights_epoch104.pth'
        ...
        img_labelID = plt.imread('unet/training/gtFine_trainvaltest/gtFine/train/aachen/aachen_000000_000019_gtFine_labelIds.png')
        ...
        # define and report the network
        model = Unet(3, 34)
        weights_file_path = 'unet/models/weights_epoch104.pth' #69 67 6262 6161 60 52 51
        dir_path = 'data/' + image_folder + '/image_03/data/'#'/home/chendh/Pytorch_Projects/jupyter_notebook_files/EECS504_Files/Project/Datasets/leftImg8bit_trainvaltest/leftImg8bit/train/aachen/aachen_000000_000019_leftImg8bit.png'#'/home/chendh/Pytorch_Projects/jupyter_notebook_files/EECS504_Files/Project/Datasets/Prediction/0000000068.png'
        '''
