...
data_dir = strcat('data/',filename);
image_dir = strcat('data/',filename);
data = read_kitti(data_dir);
...
% record video - Uncomment to record video
...
% saves video - Uncomment to save video
%close(vo);
